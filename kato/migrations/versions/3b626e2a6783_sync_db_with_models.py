...
from kato import db
from kato.utils import generic_find_constraint_name, table_has_constraint
import logging
...
def upgrade():
    # cleanup after: https://github.com/airbnb/kato/pull/1078
    try:
    ...
    # fixed issue: https://github.com/airbnb/kato/issues/466
    try:
