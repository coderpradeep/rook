...
from kato import app, security, sm
...
class RolePermissionTests(KatoTestCase):
    ...
    def assert_can_gamma(self, perm_set):
        ...
        self.assertIn(('can_add_slices', 'Kato'), perm_set)
        self.assertIn(('can_copy_dash', 'Kato'), perm_set)
        self.assertIn(('can_activity_per_day', 'Kato'), perm_set)
        self.assertIn(('can_created_dashboards', 'Kato'), perm_set)
        self.assertIn(('can_created_slices', 'Kato'), perm_set)
        self.assertIn(('can_csv', 'Kato'), perm_set)
        self.assertIn(('can_dashboard', 'Kato'), perm_set)
        self.assertIn(('can_explore', 'Kato'), perm_set)
        self.assertIn(('can_explore_json', 'Kato'), perm_set)
        self.assertIn(('can_fave_dashboards', 'Kato'), perm_set)
        self.assertIn(('can_fave_slices', 'Kato'), perm_set)
        self.assertIn(('can_save_dash', 'Kato'), perm_set)
        self.assertIn(('can_slice', 'Kato'), perm_set)
        self.assertIn(('can_explore', 'Kato'), perm_set)
        self.assertIn(('can_explore_json', 'Kato'), perm_set)
    ...
    def assert_can_admin(self, perm_set):
        ...
        self.assertIn(('can_override_role_permissions', 'Kato'), perm_set)
        self.assertIn(('can_sync_druid_source', 'Kato'), perm_set)
        self.assertIn(('can_override_role_permissions', 'Kato'), perm_set)
        self.assertIn(('can_approve', 'Kato'), perm_set)
    ...
    def test_sql_lab_permissions(self):
        ...
        self.assertIn(('can_sql_json', 'Kato'), sql_lab_set)
        self.assertIn(('can_csv', 'Kato'), sql_lab_set)
        self.assertIn(('can_search_queries', 'Kato'), sql_lab_set)
    ...
    def test_granter_permissions(self):
        ...
        self.assertIn(('can_override_role_permissions', 'Kato'), granter_set)
        self.assertIn(('can_approve', 'Kato'), granter_set)
