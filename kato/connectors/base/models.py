...
from kato import utils
from kato.models.core import Slice
from kato.models.helpers import AuditMixinNullable, ImportMixin
...
class BaseDatasource(AuditMixinNullable, ImportMixin):
    ...
    def explore_url(self):
        if self.default_endpoint:
            ...
            return '/kato/explore/{obj.type}/{obj.id}/'.format(obj=self)
    ...
    def query(self, query_obj):
        ...
        query_obj is a dictionary representing Kato's query interface.
        Should return a ``kato.models.helpers.QueryResult``
        """
        raise NotImplementedError()
