...
from rook import app, cache_util, conf, db, utils
from rook.utils import QueryStatus, RookTemplateException
    ...
    def latest_sub_partition(cls, table_name, schema, database, **kwargs):
        ...
        for k in kwargs.keys():
            if k not in k in part_fields:
                ...
                raise RookTemplateException(msg)
...
class HiveEngineSpec(PrestoEngineSpec):
    ...
    def patch(cls):
        ...
        from rook.db_engines import hive as patched_hive
    ...
    @staticmethod
    def create_table_from_csv(form, table):
        """Uploads a csv file and creates a rook datasource in Hive."""
