...
const sandboxUrl = (
  'https://github.com/apache/incubator-kato/' +
  'blob/master/kato/assets/javascripts/modules/sandbox.js');
const jsFunctionInfo = (
  <div>
    {t('For more information about objects are in context in the scope of this function, refer to the')}
    <a href={sandboxUrl}>
      {t(" source code of Kato's sandboxed parser")}.
    </a>.
  </div>
);
...
export const controls = {
  ...
  select_country: {
    ...
    description: t('The name of country that Kato should display'),
  },
  country_fieldtype: {
    type: 'SelectControl',
    ...
    description: t('The country code standard that Kato should expect ' +
  ...
  time_grain_sqla: {
    ...
    'engine basis in the Kato source code.'),
    mapStateToProps: state => ({
