...
from kato import appbuilder, db, security, sm, utils
from kato.connectors.base.views import DatasourceModelView
from kato.connectors.connector_registry import ConnectorRegistry
from kato.utils import has_access
from kato.views.base import (
    BaseKatoView, DatasourceFilter, DeleteMixin,
    get_datasource_exist_error_mgs, ListWidgetWithCheckboxes, KatoModelView,
    validate_json, YamlExportMixin,
)
from . import models


class DruidColumnInlineView(CompactCRUDMixin, KatoModelView):  # noqa
...
class DruidMetricInlineView(CompactCRUDMixin, KatoModelView):  # noqa
...
class DruidClusterModelView(KatoModelView, DeleteMixin, YamlExportMixin):  # noqa
