...
from rook import appbuilder
from rook.models.annotations import Annotation, AnnotationLayer
from .base import DeleteMixin, RookModelView


class AnnotationModelView(RookModelView, DeleteMixin):  # noqa
...
class AnnotationLayerModelView(RookModelView, DeleteMixin):
