# -*- coding: utf-8 -*-
"""Utility functions used across Rook"""
...
class RookTimeoutException(RookException):
    pass


class RookSecurityException(RookException):
    pass


class MetricPermException(RookException):
    pass


class NoDataException(RookException):
    pass


class RookTemplateException(RookException):
    pass
...
def decode_dashboards(o):
    ...
    from rook.connectors.sqla.models import (
...
def validate_json(obj):
    if obj:
        try:
            ...
            raise RookException('JSON is not valid')
...
class timeout(object):
    ...
    def handle_timeout(self, signum, frame):
        ...
        raise RookTimeoutException(self.error_message)
...
def notify_user_about_perm_udate(
    ...
    logging.info(msg)
    subject = __('[Rook] Access to the datasource %(name)s was granted',
