...
from rook.models.helpers import AuditMixinNullable, ImportMixin
...
class BaseDatasource(AuditMixinNullable, ImportMixin):
    ...
    def explore_url(self):
        if self.default_endpoint:
            ...
            return '/rook/explore/{obj.type}/{obj.id}/'.format(obj=self)
    ...
    def query(self, query_obj):
        ...
        query_obj is a dictionary representing Rook's query interface.
        Should return a ``rook.models.helpers.QueryResult``
        """
        raise NotImplementedError()
