...
from kato import appbuilder
from kato.models.sql_lab import Query, SavedQuery
from .base import BaseKatoView, DeleteMixin, KatoModelView


class QueryView(KatoModelView):
...
class SavedQueryView(KatoModelView, DeleteMixin):
