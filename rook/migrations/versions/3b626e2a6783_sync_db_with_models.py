...
from rook import db
from rook.utils import generic_find_constraint_name, table_has_constraint
import logging
...
def upgrade():
    # cleanup after: https://github.com/airbnb/rook/pull/1078
    try:
    ...
    # fixed issue: https://github.com/airbnb/rook/issues/466
    try:
