...
from kato.views.base import (
    ...
    ListWidgetWithCheckboxes, KatoModelView, YamlExportMixin,
)
from . import models


class TableColumnInlineView(CompactCRUDMixin, KatoModelView):  # noqa
    ...
    description_columns = {
        ...
        'database_expression': utils.markdown(
            ...
            'Kato uses default expression based on DB URI if this '
            'field is blank.', True),
    }
    label_columns = {
...
class SqlMetricInlineView(CompactCRUDMixin, KatoModelView):  # noqa
...
class TableModelView(DatasourceModelView, DeleteMixin, YamlExportMixin):  # noqa
    ...
    description_columns = {
        ...
        'description': Markup(
            ...
            'markdown</a>'),
        'sql': _(
            'This fields acts a Kato view, meaning that Kato will '
    ...
    def edit(self, pk):
        ...
        if isinstance(resp, basestring):
            return resp
        return redirect('/kato/explore/table/{}/'.format(pk))
