...
from kato.models.annotations import Annotation, AnnotationLayer
from .base import DeleteMixin, KatoModelView


class AnnotationModelView(KatoModelView, DeleteMixin):  # noqa
...
class AnnotationLayerModelView(KatoModelView, DeleteMixin):
