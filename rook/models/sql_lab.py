...
from rook import sm
from rook.models.helpers import AuditMixinNullable
from rook.utils import QueryStatus
...
class Query(Model):
    ...
    # Could be configured in the rook config.
...
class SavedQuery(Model, AuditMixinNullable):
    ...
    def pop_tab_link(self):
        return Markup("""
            <a href="/rook/sqllab?savedQueryId={self.id}">
