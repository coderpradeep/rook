...
from kato import db, import_util, sm, utils
from kato.connectors.base.models import BaseColumn, BaseDatasource, BaseMetric
from kato.jinja_context import get_template_processor
from kato.models.annotations import Annotation
from kato.models.core import Database
from kato.models.helpers import QueryResult
from kato.models.helpers import set_perm
from kato.utils import DTTM_ALIAS, QueryStatus
...
class SqlaTable(Model, BaseDatasource):
    ...
    def import_obj(cls, i_datasource, import_time=None):
        """Imports the datasource from the object to the database.
         ...
         kato instances. Audit metadata isn't copies over.
        """
