...
describe('SqlEditorLeftBar', () => {
  ...
  describe('getTableNamesBySubStr', () => {
    ...
    it('should handle table name', () => {
      ...
      return wrapper.instance().getTableNamesBySubStr('my table')
        .then((data) => {
          expect(ajaxStub.getCall(0).args[0]).to.equal('/rook/tables/1/main/my table');
  ...
  describe('fetchTables', () => {
    ...
    it('should fetch table options', () => {
      ...
      expect(ajaxStub.getCall(0).args[0]).to.equal('/rook/tables/1/main/birth_names/');
  ...
  describe('fetchSchemas', () => {
    it('should fetch schema options', () => {
      ...
      expect(ajaxStub.getCall(0).args[0]).to.equal('/rook/schemas/1/');
