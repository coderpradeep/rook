...
from kato import conf, db, import_util, sm, utils
from kato.connectors.base.models import BaseColumn, BaseDatasource, BaseMetric
from kato.exceptions import MetricPermException
from kato.models.helpers import (
...
class DruidDatasource(Model, BaseDatasource):
    ...
    def datasource_link(self):
        url = '/kato/explore/{obj.type}/{obj.id}/'.format(obj=self)
        name = escape(self.datasource_name)
