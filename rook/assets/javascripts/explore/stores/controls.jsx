...
const sandboxUrl = (
  'https://github.com/apache/incubator-rook/' +
  'blob/master/rook/assets/javascripts/modules/sandbox.js');
const jsFunctionInfo = (
  <div>
    {t('For more information about objects are in context in the scope of this function, refer to the')}
    <a href={sandboxUrl}>
      {t(" source code of Rook's sandboxed parser")}.
    </a>.
  </div>
);
...
export const controls = {
  ...
  select_country: {
    ...
    description: t('The name of country that Rook should display'),
  },
  country_fieldtype: {
    type: 'SelectControl',
    ...
    description: t('The country code standard that Rook should expect ' +
  ...
  time_grain_sqla: {
    ...
    'engine basis in the Rook source code.'),
    mapStateToProps: state => ({
