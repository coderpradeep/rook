...
class BaseRookView(BaseView):
    ...
    def rejected_datasources(self, sql, database, schema):
        rook_query = sql_parse.RookQuery(sql)
        return [
            t for t in rook_query.tables if not
...
class ListWidgetWithCheckboxes(ListWidget):
    ...
    template = 'rook/fab_overrides/list_with_checkboxes.html'
...
class DatasourceFilter(RookFilter):
