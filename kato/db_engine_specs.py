...
from kato import app, cache_util, conf, db, utils
from kato.exceptions import KatoTemplateException
from kato.utils import QueryStatus
    ...
    def latest_sub_partition(cls, table_name, schema, database, **kwargs):
        ...
        for k in kwargs.keys():
            if k not in k in part_fields:
                ...
                raise KatoTemplateException(msg)
...
class HiveEngineSpec(PrestoEngineSpec):
    ...
    def patch(cls):
        ...
        from kato.db_engines import hive as patched_hive
    ...
    @staticmethod
    def create_table_from_csv(form, table):
        """Uploads a csv file and creates a kato datasource in Hive."""
