...
from rook import utils, config  # noqa

APP_DIR = os.path.dirname(__file__)
CONFIG_MODULE = os.environ.get('SUPERSET_CONFIG', 'rook.config')
...
class MyIndexView(IndexView):
    @expose('/')
    def index(self):
        return redirect('/rook/welcome')


appbuilder = AppBuilder(
    app,
    db.session,
    base_template='rook/base.html',
