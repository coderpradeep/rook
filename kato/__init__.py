...
from kato import utils, config  # noqa

APP_DIR = os.path.dirname(__file__)
CONFIG_MODULE = os.environ.get('SUPERSET_CONFIG', 'kato.config')
...
class MyIndexView(IndexView):
    @expose('/')
    def index(self):
        return redirect('/kato/welcome')


appbuilder = AppBuilder(
    app,
    db.session,
    base_template='kato/base.html',
