# -*- coding: utf-8 -*-
"""Utility functions used across Kato"""
...
from kato.exceptions import KatoException, KatoTimeoutException
...
def decode_dashboards(o):
    ...
    from kato.connectors.sqla.models import (
...
def validate_json(obj):
    if obj:
        try:
            ...
            raise KatoException('JSON is not valid')
...
class timeout(object):
    ...
    def handle_timeout(self, signum, frame):
        ...
        raise KatoTimeoutException(self.error_message)
...
def notify_user_about_perm_udate(
    ...
    logging.info(msg)
    subject = __('[Kato] Access to the datasource %(name)s was granted',
