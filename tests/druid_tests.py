...
from kato import db, security, sm
...
class DruidTests(KatoTestCase):
    ...
    @patch('kato.connectors.druid.models.PyDruid')
    def test_client(self, PyDruid):
        ...
        resp = self.get_resp('/kato/explore/druid/{}/'.format(
            datasource_id))
        ...
        # One groupby
        url = ('/kato/explore_json/druid/{}/'.format(datasource_id))
    ...
    def test_druid_sync_from_config(self):
        ...
        def check():
            resp = self.client.post('/kato/sync_druid/', data=json.dumps(cfg))
            druid_ds = (
                db.session
