...
export function fetchQueryResults(query) {
  return function (dispatch) {
    ...
    const sqlJsonUrl = `/rook/results/${query.resultsKey}/`;
    $.ajax({
      type: 'GET',
      dataType: 'json',
      url: sqlJsonUrl,
...
export function runQuery(query) {
  return function (dispatch) {
    ...
    const sqlJsonUrl = '/rook/sql_json/' + location.search;
    $.ajax({
      type: 'POST',
      dataType: 'json',
      url: sqlJsonUrl,
...
export function postStopQuery(query) {
  return function (dispatch) {
    const stopQueryUrl = '/rook/stop_query/';
...
export function addTable(query, tableName, schemaName) {
  return function (dispatch) {
    ...
    let url = `/rook/table/${query.dbId}/${tableName}/${schemaName}/`;
    $.get(url, (data) => {
    ...
    url = `/rook/extra_table_metadata/${query.dbId}/${tableName}/${schemaName}/`;
    $.get(url, (data) => {
