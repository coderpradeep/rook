...
from rook import app, cache, get_manifest_file, utils
from rook.utils import DTTM_ALIAS, merge_extra_filters
...
class TableViz(BaseViz):
    ...
    credits = 'a <a href="https://github.com/airbnb/rook">Rook</a> original'
    is_timeseries = False
...
class WorldMapViz(BaseViz):
    ...
    def get_data(self, df):
        from rook.data import countries
        fd = self.form_data
        cols = [fd.get('entity')]
        metric = fd.get('metric')
        secondary_metric = fd.get('secondary_metric')
...
class DeckGLMultiLayer(BaseViz):
    ...
    def get_data(self, df):
        ...
        from rook.models.core import Slice
        from rook import db
