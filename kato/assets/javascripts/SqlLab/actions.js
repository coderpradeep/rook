...
export function fetchQueryResults(query) {
  return function (dispatch) {
    ...
    const sqlJsonUrl = `/kato/results/${query.resultsKey}/`;
    $.ajax({
      type: 'GET',
      dataType: 'json',
      url: sqlJsonUrl,
...
export function runQuery(query) {
  return function (dispatch) {
    ...
    const sqlJsonUrl = '/kato/sql_json/' + location.search;
    $.ajax({
      type: 'POST',
      dataType: 'json',
      url: sqlJsonUrl,
...
export function postStopQuery(query) {
  return function (dispatch) {
    const stopQueryUrl = '/kato/stop_query/';
...
export function addTable(query, tableName, schemaName) {
  return function (dispatch) {
    ...
    let url = `/kato/table/${query.dbId}/${tableName}/${schemaName}/`;
    $.get(url, (data) => {
    ...
    url = `/kato/extra_table_metadata/${query.dbId}/${tableName}/${schemaName}/`;
    $.get(url, (data) => {
