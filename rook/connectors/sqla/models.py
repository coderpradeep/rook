...
from rook import db, import_util, sm, utils
from rook.connectors.base.models import BaseColumn, BaseDatasource, BaseMetric
from rook.jinja_context import get_template_processor
from rook.models.annotations import Annotation
from rook.models.core import Database
from rook.models.helpers import QueryResult
from rook.models.helpers import set_perm
from rook.utils import DTTM_ALIAS, QueryStatus
...
class SqlaTable(Model, BaseDatasource):
    ...
    def import_obj(cls, i_datasource, import_time=None):
        """Imports the datasource from the object to the database.
         ...
         rook instances. Audit metadata isn't copies over.
        """
