...
class BaseKatoView(BaseView):
    ...
    def rejected_datasources(self, sql, database, schema):
        kato_query = sql_parse.KatoQuery(sql)
        return [
            t for t in kato_query.tables if not
...
class ListWidgetWithCheckboxes(ListWidget):
    ...
    template = 'kato/fab_overrides/list_with_checkboxes.html'
...
class DatasourceFilter(KatoFilter):
